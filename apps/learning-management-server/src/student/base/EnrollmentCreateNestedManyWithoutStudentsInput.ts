...
@InputType()
class EnrollmentCreateNestedManyWithoutStudentsInput {
...
export { EnrollmentCreateNestedManyWithoutStudentsInput as EnrollmentCreateNestedManyWithoutStudentsInput };
